...
В этом репозитории хранятся конфигурации контейнеров, используемых в GitLab CI для сборки и запуска тестов.
...
Пример установки образов с `gcc 15` и `clang 21` (в зависимости от задания, версии, используемые в CI, могут отличаться):
```shell
docker pull ghcr.io/cpp-kt/ubuntu:gcc-15
docker pull ghcr.io/cpp-kt/ubuntu:clang-21
```
